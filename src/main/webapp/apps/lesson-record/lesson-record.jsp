...
<br><p class = "pnote">请在课程表内，选择您本周上过的课程。</p>
...
<form id="change">
    <br><p class = "pnote">请键入您需要告知的更多信息。（若为首次使用此应用程序，请在此提供您的学号，用于可能的管理套件的用户ID。）</p><input type="text"  name="info" placeholder="如：19-22日请假。或留空。"/><br>
